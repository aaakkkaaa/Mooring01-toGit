    ...
    public class BurstColliderWorld : MonoBehaviour, IColliderWorldImpl
    {
        ...
        public void DecreaseReferenceCount()
        {
            if (--refCount <= 0 && gameObject != null)
                DestroyImmediate(gameObject);  //TODO: error during rope OnValidate.
        }
        ...
        public void UpdateWorld()
        {
            var identifyMoving = new IdentifyMovingColliders
            {
                ...
                colliders = ObiColliderWorld.GetInstance().colliderShapes.AsNativeArray<BurstColliderShape>(),
                bounds = ObiColliderWorld.GetInstance().colliderAabbs.AsNativeArray<BurstAabb>(),
