...
namespace Obi
{
    public abstract class BurstConstraintsBatchImpl : IConstraintsBatchImpl
    {
        ...
        protected int m_ActiveConstraintCount = 0;
        ...
        public BurstConstraintsBatchImpl dependency;
        ...
        public BurstConstraintsBatchImpl() { }
        ...
        {
            m_ActiveConstraintCount = activeConstraintCount;
        }
