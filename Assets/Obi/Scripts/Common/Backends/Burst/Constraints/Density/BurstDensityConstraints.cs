...
namespace Obi
{
    public class BurstDensityConstraints : BurstConstraintsImpl<BurstDensityConstraintsBatch>, IConstraintsImpl<IDensityConstraintsBatchImpl>
    {
        ...
        public IDensityConstraintsBatchImpl CreateConstraintsBatch()
        {
        ...
        public void RemoveBatch(IDensityConstraintsBatchImpl batch)
        {
