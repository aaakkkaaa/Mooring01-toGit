...
//    private float M0 = 8680f;                // водоизмещение = вес яхты в кг
    ...
    private float K66 = 1.34f;              // коеф. для расчета массы и момента с учетом прис.  Jyy = (1+K66)*Jy; Mxx = (1+K66)*M0. Обратная линейная зависимости от скорости Vz
...
//        _KresZ1 = _KresZ2 * 3.0f;             // подбором 
        ...
        _Record.MyLog("EngineV:\tKprop4:\tFeng\tRuderValue\tFresZ\tFresX\tFrudVzZ\tFrudVzX\tMrudVzX\tFrudEnZ\tFrudEnX\tMrudEnX\tMrudResZ\tMresBody\tFengX\tMengX\tFwindZ\tFwindX\tMwind\tdVz\tVz\tdVx\tVx\tdOmegaY\tOmegaY\tBeta\tdt\tK66");
    ...
    */
    ...
    void FixedUpdate()
    {
        ...
        // Коэф. для расчета массы с учетом прис.  Mxx = (1+K66)*M0. Линейная зависимости от Feng - подбором
        if (engineValue >= 0f)
        // Передний ход: при engineValue=0,681818182 (1500/2200) K66=0.8; при engineValue=0,909090909 (2000 /2200) K66=0.53
        {
            ...
            _Jyy = 1.53f * Jy; // момент инерции с учетом присоединенных масс
        }
        else
            // Задний ход: при engineValue=-0,454545455 (-1000 /2200) K66=1.4; при engineValue=-0,159090909 (-350 /2200) K66=2
        {
            ...
            _Jyy = 0.1f * Jy; // момент инерции с учетом присоединенных масс
        }
...
*/
        _Record.MyLog(engineValue + "\t" + _Kprop4 + "\t" + Feng + "\t" + RuderValue + "\t" + FresZ + "\t" + FresX + "\t" + FrudVzZ + "\t" + FrudVzX + "\t" + MrudVzX + "\t" + FrudEnZ + "\t" + FrudEnX + "\t" + MrudEnX + "\t" + MrudResZ + "\t" + MresBody + "\t" + FengX + "\t" + MengX + "\t" + FwindZ + "\t" + FwindX + "\t" + Mwind + "\t" + dVz + "\t" + Vz + "\t" + dVx + "\t" + Vx + "\t" + dOmegaY + "\t" + OmegaY + "\t" + Beta + "\t" + dt + "\t" + K66);
